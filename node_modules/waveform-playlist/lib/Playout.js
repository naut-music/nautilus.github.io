  ...
  setUpSource() {
    ...
    const sourcePromise = new Promise(resolve => {
      ...
      this.source.onended = () => {
        ...
        this.panner.disconnect(); // this.masterGain.disconnect();
    ...
    cleanupEffects = this.effectsGraph(this.panner, this.masterGain, this.ac instanceof OfflineAudioContext);
    cleanupMasterEffects = this.masterEffectsGraph(this.masterGain, this.destination, this.ac instanceof OfflineAudioContext);
